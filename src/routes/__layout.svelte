...
<header class="flex flex-shrink-0 h-28 shadow">
    <nav class="container mx-auto px-8 text-xl font-bold flex space-x-1">
        ...
        <a href="/klandringer/indbetalinger" class:active={/^\/klandringer\/indbetalinger/.test($page.path)}>Indbetalinger</a>
    </nav>
</header>
